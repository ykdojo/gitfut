...
// with this repo's own engine (see distribution/README.md for methodology).
// Regenerated by distribution/build-data.py — do not edit by hand.
export const DIST_MIN = 50;
export const DIST_N = 18107;
export const DIST_DATE = "2026-07-04";
// counts[i] = number of sampled users with overall rating DIST_MIN + i
...
// same, restricted to accounts with >= 1 contribution in the past year
